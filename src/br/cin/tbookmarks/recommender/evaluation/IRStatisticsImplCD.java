...
public final class IRStatisticsImplCD implements IRStatistics, Serializable {
  ...
  IRStatisticsImplCD(double precision, double recall, double fallOut, double ndcg, double reach) {
  ...
  IRStatisticsImplCD(double precision, double recall) {
	    Preconditions.checkArgument(Double.isNaN(precision) || (precision >= 0.0 && precision <= 1.0),
	        "Illegal precision: " + precision + ". Must be: 0.0 <= precision <= 1.0 or NaN");
	    Preconditions.checkArgument(Double.isNaN(recall) || (recall >= 0.0 && recall <= 1.0), 
	        "Illegal recall: " + recall + ". Must be: 0.0 <= recall <= 1.0 or NaN");
  ...
  public String toString() {
    return "IRStatisticsImplCD[precision:" + precision + ",recall:" + recall + ",fallOut:"
